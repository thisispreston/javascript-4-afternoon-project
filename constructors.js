...
function Employee(name, email, hireDate) {
 ...
 //invoking constructors always requires 'new' keyword
  ...
  */
  ...
  Movie.prototype.changeRating = function changeRating (num1) {
    return this.rating + num1 / 2
  }
  ...
  User.prototype.removeSavedPost = function (num1) {
    for (i = 0; i < this.savedPosts.length; i++)
      if (num1 === this.savedPosts[i].id) {
